...
export function HeaderComponent(props: IProps) {
  ...
  return (
    <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
      ...
      <ul className="ml-1 mt-8 flex items-center bottom-0" aria-label="Social media">
        <li className="mr-5 text-xs shrink-0">
          <a className="block hover:text-slate-200" href={github} target="_blank" rel="noreferrer noopener" aria-label="GitHub (opens in a new tab)" title="GitHub">
        ...
        <li className="mr-5 text-xs shrink-0">
          <a className="block hover:text-slate-200" href={linkedIn} target="_blank" rel="noreferrer noopener" aria-label="LinkedIn (opens in a new tab)" title="LinkedIn">
